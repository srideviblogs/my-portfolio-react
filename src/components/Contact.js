  ...
  return (
    <section id="contact" className="bg-black text-white py-16 px-6 text-center">
      ...
      <div className="flex justify-center gap-6 text-3xl">
        <a href="mailto:sridevivelpula@gmail.com" className="hover:text-pink-400">
          <FaEnvelope />
        </a>
        <a href="https://github.com/srideviblogs" target="_blank" rel="noopener noreferrer" className="hover:text-pink-400">
          <FaGithub />
        </a>
        <a href="https://linkedin.com/in/sridevi-velpula" target="_blank" rel="noopener noreferrer" className="hover:text-pink-400">
          <FaLinkedin />
        </a>
      </div>
    </section>
